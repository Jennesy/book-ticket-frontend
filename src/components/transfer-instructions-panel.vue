  ...
  <Dialog modelValue='true' width='500' :fullscreen='isMobile' @close='onClose'>
    ...
    <div class='flex flex-col gap-6'>
      <div class='flex gap-2 items-start'>
        ...
        <div class='mobile:text-lg'>前往<a href='https://docs.google.com/spreadsheets/d/1b9FVc7L0r_NvNOFQJsuUSoazTQKjKubuInqlOjRiM0c/edit?usp=sharing' target='_blank'>
          ...
          ，確認 
          <span class='font-bold border-b-solid'>訂單編碼</span> 與 
          <span class='font-bold border-b-solid'>金額</span>
        </div>
      </div>
      <div class='flex gap-2 items-start'>
